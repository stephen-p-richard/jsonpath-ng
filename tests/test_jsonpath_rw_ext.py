...
class Testjsonpath_ng_ext(testscenarios.WithScenarios,
    ...
    scenarios = [
        ...
        ('filter_and_demorgans', dict(string='objects[?!(cow<=5|cat!=2)]',
                                      ...
                                      target=[{'cow': 8, 'cat': 2},
                                              {'cow': 7, 'cat': 2}])),
        ('filter_and_triple', dict(string='objects[?cow>5&cat=2&&dog!=2]',
                                   ...
                                   target=[{'cow': 8, 'cat': 2, 'dog': 1},
                                           {'cow': 7, 'cat': 2, 'dog': 3}])),
        ('filter_or', dict(string='objects[?(cow>7 | cat=2)]',
                           data={'objects': [{'cow': 8, 'cat': 2, 'dog': 1},
                                             {'cow': 4, 'cat': 1, 'dog': 1},
                                             {'cow': 2, 'cat': 3, 'dog': 1},
                                             {'cow': 5, 'cat': 3, 'dog': 0},
        ...
        ('filter_or_demorgans', dict(string='objects[?!(cow!=8&cat!=3)]',
                                     ...
                                     target=[{'cow': 8, 'cat': 2},
                                             {'cow': 5, 'cat': 3},
                                             {'cow': 8, 'cat': 3}])),
        ('filter_or_triple', dict(string='objects[?(cow>7|cat=2||dog==0)]',
                                  data={'objects': [{'cow': 8, 'cat': 2, 'dog': 1},
                                                    {'cow': 4, 'cat': 1, 'dog': 1},
                                                    {'cow': 2, 'cat': 3, 'dog': 1},
                                                    {'cow': 5, 'cat': 3, 'dog': 0},
                                  ...
                                  target=[{'cow': 8, 'cat': 2, 'dog': 1},
                                          ...
                                          {'cow': 5, 'cat': 2, 'dog': 1},
                                          {'cow': 8, 'cat': 3, 'dog': 1}])),
        ('filter_or_and', dict(string='objects[?(cow=5|cat=2&dog=0)]',
                               data={'objects': [{'cow': 8, 'cat': 2, 'dog': 1},
                                                 {'cow': 4, 'cat': 1, 'dog': 1},
                                                 {'cow': 2, 'cat': 2, 'dog': 0},
                                                 {'cow': 5, 'cat': 3, 'dog': 0},
                                                 {'cow': 5, 'cat': 3, 'dog': 1},
                                                 {'cow': 8, 'cat': 3, 'dog': 0}]},
                               target=[{'cow': 2, 'cat': 2, 'dog': 0},
                                       {'cow': 5, 'cat': 3, 'dog': 0},
                                       {'cow': 5, 'cat': 3, 'dog': 1}])),
        ('filter_or_and_other_way', dict(string='objects[?(dog=0&cow=5|cat=2)]',
                                         data={'objects': [{'cow': 8, 'cat': 2, 'dog': 1},
                                                           {'cow': 4, 'cat': 1, 'dog': 1},
                                                           {'cow': 2, 'cat': 2, 'dog': 0},
                                                           {'cow': 5, 'cat': 3, 'dog': 0},
                                         ...
                                         target=[{'cow': 8, 'cat': 2, 'dog': 1},
                                                 {'cow': 2, 'cat': 2, 'dog': 0},
                                                 {'cow': 5, 'cat': 3, 'dog': 0}])),
        ('filter_and_or', dict(string='objects[?@.cow=5&&@.cat=2||@.dog=0]',
                               data={'objects': [{'cow': 8, 'cat': 2, 'dog': 1},
                                                 {'cow': 4, 'cat': 1, 'dog': 0},
                                                 {'cow': 5, 'cat': 2, 'dog': 1},
                                                 {'cow': 1, 'cat': 99, 'dog': 0},
                                                 {'cow': 5, 'cat': 3, 'dog': 1},
                                                 {'cow': 8, 'cat': 3, 'dog': 1}]},
                               target=[{'cow': 4, 'cat': 1, 'dog': 0},
                                       {'cow': 5, 'cat': 2, 'dog': 1},
                                       {'cow': 1, 'cat': 99, 'dog': 0}])),
        ('filter_and_or_brackets', dict(string='objects[?@.cow=5&&(@.cat=2||@.dog=0)]',
                                        data={'objects': [{'cow': 8, 'cat': 2, 'dog': 1},
                                                          {'cow': 4, 'cat': 1, 'dog': 0},
                                                          {'cow': 5, 'cat': 2, 'dog': 1},
                                                          {'cow': 1, 'cat': 99, 'dog': 0},
        ...
        ('filter_complex', dict(string='$.items[?((!(val==4))&(id==2))|(!((id!=1)&(id!=3)))]',
                                ...
                                target=[{'info': 1, 'id': 1, 'val': 1},
                                        {'id': 2, 'val': 2},
                                        {'id': 3, 'val': 3}])),
        ('filter_in', dict(string='objects[?cow in [2, "moo"]]',
                           data={'objects': [{'cow': 8, 'cat': 2, 'dog': 1},
                                             {'cow': "moo", 'cat': 1, 'dog': 1},
                                             {'cow': 2, 'cat': 3, 'dog': 1},
                                             {'cow': 5, 'cat': 3, 'dog': 0},
        ...
        ('arithmetic_number_only', dict(string='3 * 3', data={},
                                        target=[9])),
        ('arithmetic_float_number', dict(string='3.0 * 3', data={},
                                         target=[9])),
        ('arithmetic_number_float', dict(string='3 * 3.5', data={},
                                         target=[10.5])),
        ...
        ('arithmetic_mul5', dict(string='foo * 3', data={'foo': 'f'},
                                 target=['foofoofoo'])),
        ('arithmetic_mul6', dict(string='($.foo * 10 * $.foo) + 2.5',
                                 data={'foo': 4}, target=[162.5])),
        ('arithmetic_mul7', dict(string='$.foo * 10 * $.foo + 2',
                                 data={'foo': 4}, target=[240])),
        ('arithmetic_mul8', dict(string='$.foo * $.bar', data={'foo': 3, 'bar': 4},
                                 target=[12])),
